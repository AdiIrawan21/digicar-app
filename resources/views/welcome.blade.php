        ...
        <nav class="navbar navbar-expand-lg fs-5 p-2">
                        ...
                        <div id="carouselExampleControls" class="carousel slide w-100" data-bs-ride="carousel">
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <h5 class="p-3 mx-auto w-50 text-center align-item-center" style="background-color: #FEE3E0; border-radius: 15px; margin-top:40px;">Lihat Produk</h5>
                            </div>
          ...
          <section id="carouselProduk">
            <div class="container">
                ...
                <p class="text-end me-5 fs-5"><a href="/produk" style="color: white;">Lihat Semua</a></p>
                      ...
                      <div class="row justify-content-evenly">
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          ...
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" href="" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color:#A80743; color:white;">Chat melalui WhatsApp</button>
                                          </div>
                                        </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #5C5656;">
                                          ...
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color: #FEE3E0; color: #5C5656;">Chat melalui WhatsApp</button>
                                          </div>
                                        </div>
                                        ...
                                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: #FEE3E0;">
                                          ...
                                          <div class="card-body text-center mb-4" style="">
                                            <button onclick="welcome(event)" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color:#A80743; color:white;">Chat melalui WhatsApp</button>
                                          </div>
                                        </div>
                                      </div>
                    </div>
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="row justify-content-center">
                          <div class="card me-4 d-flex justify-content-center align-items-center" style="max-width: 520px; max-height: 250px; background-color:#FFF8F7; border-radius: 20px;">
                            <div class="row g-0 align-items-center">
                              <div class="col-md-4">
                                <img src="{{asset('images/customerSatu.svg')}}" class="img-fluid rounded-start" alt="...">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body">
                            ...
                            <div class="card" style="width: 16rem; background-color:#FFF8F7; border-radius: 20px;">
                              <div class="d-flex justify-content-center p-2 mt-4 mb-4">
                                <img src="{{asset('images/customerDua.svg')}}" class="card-img-top" alt="..." style="max-width: 10rem;">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="carousel-item">
                        <div class="row justify-content-center">
                          <div class="card me-4 d-flex justify-content-center align-items-center" style="max-width: 520px; max-height: 250px; background-color:#FFF8F7; border-radius: 20px;">
                            <div class="row g-0 align-items-center">
                              <div class="col-md-4">
                                <img src="{{asset('images/customerDua.svg')}}" class="img-fluid rounded-start" alt="...">
                              </div>
                              <div class="col-md-8">
                                <div class="card-body">
                            ...
                            <div class="card" style="width: 16rem; background-color:#FFF8F7; border-radius: 20px;">
                              <div class="d-flex justify-content-center p-2 mt-4 mb-4">
                                <img src="{{asset('images/customerSatu.svg')}}" class="card-img-top" alt="..." style="max-width: 10rem;">
                              </div>
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="card me-4 d-flex justify-content-center align-items-center" style="max-width: 520px; max-height: 250px; background-color:#FFF8F7; border-radius: 20px;">
                            <div class="row g-0 align-items-center">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  <h5 class="card-title">Johanes</h5>
                                  <p class="card-text">Siap makasih puas dengan pelayanannya. Akan saya rekomendasikan ke orang lain.</p>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="col-5 border" style="border-radius: 50px;">
                    <form class="row" id="subscribeForm">
                      ...
                      <div class="col mt-2 mb-2">
                        <button id="subscribeBtn"type="submit" class="btn p-3" style="border-radius: 50px; background-color: #FEE3E0;">Berlangganan Sekarang</button>
                      </div>
                    </form>
                  </div>
