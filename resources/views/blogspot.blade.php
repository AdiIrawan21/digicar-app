                    ...
                    <div class="col">
                      <div class="card h-100" style="background-color: #FFF8F7; border-bottom-right-radius: 30px; border: none;">
                        ...
                        <div class="text-end p-4">
                            <a href="{{ url('/selengkapnya/'.$item->id_blog) }}" class="btn" style="background-color: #A80743; color:white; border-radius: 10px;">Selengkapnya</a>
                        </div>
                      </div>
                    </div>
                    @endforeach
                ...
                <div class="row row-cols-1 row-cols-md-3 mt-5">
                    ...
                    <div class="col">
                      <div class="card h-100" style="background-color: #FFF8F7; border-bottom-right-radius: 30px; border: none;">
                        ...
                        <div class="text-end p-4">
                            <a href="/selengkapnya" class="btn" style="background-color: #A80743; color:white; border-radius: 10px;">Selengkapnya</a>
                        </div>
                      </div>
                    </div>
