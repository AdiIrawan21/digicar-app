          ...
          <section id="cardMobil">
              <div class="container">
                  <div class="row row-cols-1 row-cols-md-3 g-5 mx-5" style="">
                    ...
                    <div class="col">
                        <div class="card" style="width: 23rem; border-radius: 20px; background-color: {{ $index < 2 ? '#FEE3E0' : '#5C5656' }};">
                          <img src="{{ asset('gambar').'/'.$item->gambar }}" class="card-img img-fluid p-3 mt-2" alt="...">
                          <div class="card-body">
                          ...
                          <div class="card-body text-center mb-4" style="">
                            <a onclick="welcome(event)" href="#" class="btn fs-5" role="button" data-bs-toggle="button" style="border-radius:10px; background-color:{{ $index < 2 ? '#A80743' : '#FEE3E0' }}; color:white;">Chat melalui WhatsApp</a>
                          </div>
                        </div>
                    </div>
                    @endforeach
